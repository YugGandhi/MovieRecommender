...
export default function MovieModal({ movie, open, onClose, onRate }: MovieModalProps) {
  ...
  const getPosterUrl = (path?: string) => {
    if (!path) return "https://images.unsplash.com/photo-1489599096831-daa6f2a39f7b?ixlib=rb-4.0.3&w=300&h=450&fit=crop";
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 bg-gray-900 border-gray-700">
        <div className="relative">
          ...
          <div className="h-64 bg-gradient-to-t from-gray-900 via-gray-900/50 to-transparent relative overflow-hidden">
            <img 
              src={getBackdropUrl(movie.backdropPath)}
              alt={`${movie.title} backdrop`}
              className="w-full h-full object-cover"
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?ixlib=rb-4.0.3&w=1200&h=400&fit=crop";
              }}
            />
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-shrink-0">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1489599096831-daa6f2a39f7b?ixlib=rb-4.0.3&w=300&h=450&fit=crop";
                  }}
                />
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <Button className="bg-primary hover:bg-red-700 px-8 py-3">
